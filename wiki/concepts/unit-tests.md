...
| `src/wiki/build-index.test.ts`   | Direct build/check regression coverage for preserving custom index preamble while regenerating tables          |
