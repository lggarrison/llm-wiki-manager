...
last_updated: 2026-07-08T11:20:00Z
...
| `build`        | `wiki:build`       | Regenerate `index.md` cataloging hub, entity, concept, and source pages |
...
`build` indexes every valid entity-family page type under `entities/` (`overview`, `entity`, `comparison`, and `deep-dive`) so generated catalogs match the wiki schema.
