...
- Node.js 24 for development (see [`.nvmrc`](.nvmrc); run `nvm use` or `fnm use` after clone). The published CLI supports Node >=20.12 (`engines.node`), and CI tests both 20 and 24 on Linux and Windows.
