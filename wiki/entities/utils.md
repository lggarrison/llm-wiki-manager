...
| Install config | `readInstallConfig`, `writeInstallConfig`, `isExistingInstall`, `inferInstallConfig`; `readInstallConfig` validates required fields before callers mutate files                                                             |
