...
type: concept
title: Init Command
last_updated: 2026-07-22T11:20:00Z
tags: [cli, scaffold]
...
Before writing, `init` parses any existing `.llm-wiki-manager.json` so malformed install metadata aborts without leaving a partial scaffold.
