 ...
 * Usage: node scripts/wiki/help.mjs
 */

const WIKI_DIR = 'wiki';
const SCRIPTS_DIR = 'scripts/wiki';
...
const commands = [
  ...
  {
    name: 'wiki:build',
    summary: 'Regenerate wiki/index.md from page frontmatter',
  ...
  {
    name: 'wiki:log',
    summary: 'Append an operation entry to wiki/log.md',
