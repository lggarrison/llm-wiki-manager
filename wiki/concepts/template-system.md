...
Root `AGENTS.md` is managed between explicit start/end markers. The managed-section helpers normalize marker-bearing templates and avoid discarding unbounded legacy content when upgrading files created before end markers existed.
